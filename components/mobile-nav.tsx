    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-[300px] bg-black/95">
        <nav className="flex flex-col space-y-4 mt-6">
          <Link href="/explore" className="text-lg text-white/70 hover:text-white" onClick={() => setOpen(false)}>
            Explorar
          </Link>
          <Link href="/blog" className="text-lg text-white/70 hover:text-white" onClick={() => setOpen(false)}>
            Blog
          </Link>
        </nav>
